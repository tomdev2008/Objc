...
//    HCView *view = [[HCView alloc] initWithFrame:viewFrame];
//    [view setBackgroundColor:[UIColor redColor]];
  
    
    HCView *view = [[HCView alloc] initWithFrame:[[self window] bounds]];
    [[self window] addSubview:view];
    
    BOOL success = [view becomeFirstResponder];
    if (success) {
        NSLog(@"HCView became the first responder");
    } else {
        NSLog(@"Could not become first responder");
    }
    
//    CGRect anotherFrame = CGRectMake(20, 30, 50, 50);
//    HCView *anotherView = [[HCView alloc] initWithFrame:anotherFrame];
